...
using SalesCurso.Models.Enums;

namespace SalesCurso.Data
{
    public class SeedingService
    {
        private SalesCursoContext _context;

        public SeedingService(SalesCursoContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Marie Green", "marie@gmail.com", new DateTime(1992, 1, 31), 3100.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1993, 3, 21), 5000.0, d3);
            Seller s4 = new Seller(4, "Martha red", "marta@gmail.com", new DateTime(1994, 11, 30), 1500.0, d4);
            Seller s5 = new Seller(5, "Donald Black", "donald@gmail.com", new DateTime(1995, 10, 5), 1800.0, d2);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1996, 8, 11), 4500.0, d1);
